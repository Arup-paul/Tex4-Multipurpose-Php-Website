...
<div id="main-content">
		...
		<div class="row">
			<?php
				if(isset($_GET['id'])){
						$edit_id=$_GET['id'];
						$edit_query="SELECT * FROM watch WHERE id='$edit_id'";
						$run_edit=mysql_query($edit_query);
						while($edit_row=mysql_fetch_array($run_edit)){
							$id           =$edit_row['id'];
							$new_location =$edit_row['link'];
							echo' 
									<h1>YOUTUBE LINK EDIT FORM</h1>
								<form action="youtube_edit.php" method="post">
				...
				if(isset($_POST['update'])){
					...
					$new_insert ="UPDATE watch SET link ='$new_list' WHERE id='$new_id'";
